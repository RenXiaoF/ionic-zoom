...
/*----------------------------------------后台Api地址----------------------------------------*/
// ross/api/intf_YYAPP_Main:CALL

export const APP_VERSION_SERVE_URL = 'http://192.168.2.188:5414/ross/post/';// 测试环境
export const APP_ONLINE_SERVE_URL = 'http://192.168.2.188:5414/ross/post/';// 测试环境

// export const APP_VERSION_SERVE_URL = 'http://192.168.2.99:5414/ross/api/';// 测试环境
// export const APP_ONLINE_SERVE_URL = 'http://192.168.2.99:5414/ross/api/';// 测试环境

// export const APP_ONLINE_SERVE_URL = 'http://www.ldsuit.com/index.php/customer/';// 线上环境
